...
const baseDecision: AutopilotDecision = {
  ...
  selectedOpportunity: {
    ...
    tokenOut: { symbol: "USDY", decimals: 18 },
    feeTier: 500,
    slippageBps: 75,
    deadlineSeconds: 900,
    expectedApyBps: 520,
  ...
  aiAdvisor: {
    provider: "fallback",
    model: "deterministic",
    recommendedStrategyId: "agni-usdy-safe-swap",
  ...
  action: {
    kind: "swap",
    reason: "swap into usdy",
    toStrategyId: "agni-usdy-safe-swap",
    improvementBps: 0,
    pair: "USDT/USDY",
  },
    ...
    const result = await executeRealRoute({
      decision: {
        ...
        action: {
          kind: "addLiquidity",
          reason: "add",
          toStrategyId: "agni-usdy-meth-liquidity",
          improvementBps: 100,
          pair: "USDY/mETH",
        },
        execution: {
